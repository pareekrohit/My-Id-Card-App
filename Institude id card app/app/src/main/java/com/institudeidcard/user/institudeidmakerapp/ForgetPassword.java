        ...
        btnSendSMS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isEmptyField() == true) {
                    ...
                    ForgetPasswordTask rt = new ForgetPasswordTask(ForgetPassword.this);
                    rt.execute(mobile);
                }
            }
        });
...
class ForgetPasswordTask extends AsyncTask<String, Void, String> {
    ...
    public ForgetPasswordTask(Context mctx) {
        this.mctx = mctx;
    }
    ...
    protected String doInBackground(String... data) {
        ...
        call.enqueue(new Callback<Registration_pojo>() {
            ...
            public void onResponse(Call<Registration_pojo> call, Response<Registration_pojo> response) {
                ...
                // Toast.makeText(mctx, "You Will receive sms soon", Toast.LENGTH_SHORT).show();
